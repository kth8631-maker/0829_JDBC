...
public class MemberView {
	...
	private void save() {
		...
		// 일단 View에서 할 일은 끝남 -> 컨트롤러로 요청 처리 - 최종 목적은 DB에서 INSERT
	 ...
	 * Member 테이블로부터 아이디값을 비교해서 조회한 뒤
	...
	private void update() {
		...
		int result = mc.update(userId, userPwd,newPassword); // 꼰뜨롤라로 넘겨줌
